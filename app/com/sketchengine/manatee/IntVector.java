...
public class IntVector {
  ...
  public long size() {
    return manateeJNI.IntVector_size(swigCPtr, this);
  }
  ...
  public void add(int x) {
    manateeJNI.IntVector_add(swigCPtr, this, x);
  }

  public int get(int i) {
    return manateeJNI.IntVector_get(swigCPtr, this, i);
  }

  public void set(int i, int val) {
    manateeJNI.IntVector_set(swigCPtr, this, i, val);
  }
